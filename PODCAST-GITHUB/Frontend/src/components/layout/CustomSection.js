...
const CustomSection = ({ title, subtitle }) => {
	return (
		<div className="flex flex-col items-stretch w-11/12" style={{ margin: 'auto' }}>
			{/* Section 1 */}
			<div
			...
			{/* Section 2 */}
			<div className="mt-6 text-3xl text-customOrange-light w-full flex items-center justify-center text-center p-6 border-2 border-orange-500 flex-1">
				{subtitle}
			</div>
		</div>
	);
